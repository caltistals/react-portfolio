            ...
            <div class="row text-center">
              ...
              <div class="col-md-4 services">
                ...
                <p className="text-muted">
                  主に独学でのWebアプリケーション開発に使用
                </p>
              </div>
              <div class="col-md-4 services">
                <img src={tsImage} />
                <h4>TypeScript</h4>
                <p className="text-muted">2022/7 ~</p>
                <p className="text-muted">独学やインターンでの開発に使用</p>
              </div>
              <div class="col-md-4 services">
                <img src={reactImage} />
                <h4>React</h4>
              ...
              <div class="col-md-4 services">
                ...
                <h4>Vue</h4>
                <p className="text-muted">2022/4 ~</p>
                <p className="text-muted">インターンでの開発に使用</p>
              </div>
              <div class="col-md-4 services">
